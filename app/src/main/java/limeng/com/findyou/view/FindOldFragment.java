 ...
 */
public class FindOldFragment extends Fragment {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case 1:
                    ...
                    adapter = new FindOldFragmentAdapter(tlist,getActivity());
    ...
    private FindOldFragmentAdapter adapter;
    private TextView tx;
    private static int i = 1;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view  = inflater.inflate(R.layout.findoldfragment_layout,null);
        ...
        myview.setOnPullLoadMoreListener(new PullToLoaderRecylerView.PullLoadMoreListener() {
            ...
            public void onRefresh() {
                i= 1;
                HttpUtils.request("topic/getall?pid="+i+"&pageSize=5&type=0", null, new Callback() {
                    @Override
    ...
    public void onResume() {
        super.onResume();
        HttpUtils.request("topic/getall?pid=1&pageSize=5&type=0", null, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                getActivity().runOnUiThread(new Runnable() {
                    @Override
