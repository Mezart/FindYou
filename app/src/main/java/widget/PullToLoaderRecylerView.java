 ...
 */
public class PullToLoaderRecylerView extends LinearLayout {
    ...
    public PullToLoaderRecylerView(Context context) {
        super(context);
        initView(context);
    }

    public PullToLoaderRecylerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    private void initView(Context context) {
        mContext = context;
        View view = LayoutInflater.from(context).inflate(R.layout.pull_main, null);
